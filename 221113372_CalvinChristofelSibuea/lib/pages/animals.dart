          ...
          body: Padding(
            ...
            builder: (context, soalModel, child) {
              return Column(
                ...
                children: [
                  Text(
                    soalModel.animal[soalModel.count % soalModel.animal.length]["nama"],
                    style: const TextStyle(fontSize: 60, fontFamily: 'Helvetica'),
                  ),
                  Image.asset(soalModel.animal[soalModel.count % soalModel.animal.length]["gambar"],
                    width: 250,
                  ),
                  Text(
                    soalModel.animal[soalModel.count % soalModel.animal.length]["arti"],
