          ...
          body: Padding(
            ...
            builder: (context, soalModel, child) {
              return Column(
                ...
                children: [
                  Text(
                    soalModel.number[soalModel.count % soalModel.number.length]["nama"],
                    style: const TextStyle(fontSize: 60, fontFamily: 'Helvetica'),
                  ),
                  Image.asset(soalModel.number[soalModel.count % soalModel.number.length]["gambar"],
                    width: 250,
                  ),
                  Text(
                    soalModel.number[soalModel.count % soalModel.number.length]["arti"],
